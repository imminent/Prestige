...
/* package */class _NewsReaderController
    implements NewsReaderController, Messages.NewsReaderPresentation {
...
/* News Reader Controller Contract */
  @Override public int categoryIndex() {
    return _category_index;
  }

  @Override public int articleIndex() {
...
/* News Reader Presentation Messages */
  ...
  public void onHeadlineSelected(HeadlineSelected message) {
    ...
    if (_has_two_panes) presentation.article(getCurrentCategory().getArticle(_article_index));
    else presentation.showArticleActivity(_category_index, _article_index);
  }
...
/* Helpers */
  ...
  private static final String _CATEGORIES[] = {"Top Stories", "Politics", "Economy", "Technology"};
}
