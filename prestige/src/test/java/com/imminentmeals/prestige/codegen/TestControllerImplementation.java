...
public class TestControllerImplementation {
  ...
  @Test public void sameScopeControllerImplementationsFailsIfInDifferentPackage() {
    final JavaFileObject presentation = JavaFileObjects.forResource("PresentationInterface.java");
    final JavaFileObject presentation_implementation =
        JavaFileObjects.forResource("TestPresentation.java");
    ...
    final JavaFileObject other_presentation_interface =
        JavaFileObjects.forResource("DifferentPackagePresentationInterface.java");
    final JavaFileObject other_presentation =
        JavaFileObjects.forResource("DifferentPackagePresentation.java");
    final JavaFileObject other_controller_interface =
        JavaFileObjects.forResource("DifferentPackageControllerInterface.java");
    final JavaFileObject other_controller =
        JavaFileObjects.forResource("DifferentPackageController.java");
  ...
  @Test public void sameScopeControllerImplementationsInSamePackage() {
    ...
    final JavaFileObject controller = JavaFileObjects.forResource("TestController.java");
    final JavaFileObject other_presentation =
        JavaFileObjects.forResource("OtherPresentationInterface.java");
    final JavaFileObject other_controller_interface =
        JavaFileObjects.forResource("OtherControllerInterface.java");
