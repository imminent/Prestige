...
/**
 * <p>Defines the API for finding the {@link android.app.FragmentManager} or {@link
 * android.content.Context} given an {@link Activity} or {@link Fragment}.</p>
 *
 * @author Dandre Allison
 */
public enum Finder {
  /**
   * <p>Finds the {@link android.app.FragmentManager} or {@link android.content.Context} given a
   * {@link Fragment}.</p>
   */
  FRAGMENT {
    @Override
