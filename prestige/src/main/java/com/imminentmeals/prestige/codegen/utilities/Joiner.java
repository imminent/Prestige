 ...
 *
 * <p>See the Guava User Guide article on <a href= "http://code.google.com/p/guava-libraries/wiki/StringsExplained#Joiner">{@code
 * Joiner}</a>.
 *
...
public class Joiner {
   ...
   */
  public final <A extends Appendable> A appendTo(A appendable, @Nullable Object first,
   ...
   */
  public final StringBuilder appendTo(StringBuilder builder, @Nullable Object first,
      @Nullable Object second
      , Object... rest) {
   ...
   */
  @CheckReturnValue public Joiner useForNull(final String nullText) {
   ...
   */
  @CheckReturnValue public MapJoiner withKeyValueSeparator(String keyValueSeparator) {
   ...
   *
   * <ul> <li>To output a separate entry for each key-value pair, pass {@code multimap.entries()} to
   * a {@code MapJoiner} method that accepts entries as input, and receive output of the form {@code
   * key1=A&key1=B&key2=C}. <li>To output a single entry for each key, pass {@code multimap.asMap()}
   * to a {@code MapJoiner} method that accepts a map as input, and receive output of the form
   * {@code key1=[A, B]&key2=C}. </ul>
   *
   * @since 2.0 (imported from Google Collections Library)
   */
  public final static class MapJoiner {
     ...
     */
    @CheckReturnValue public MapJoiner useForNull(String nullText) {
  ...
  private static Iterable<Object> iterable(final Object first, final Object second,
      final Object[] rest) {
    checkNotNull(rest);
