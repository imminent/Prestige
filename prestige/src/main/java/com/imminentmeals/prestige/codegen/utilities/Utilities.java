...
public final class Utilities {
   ...
   */
  public static String rawTypeToString(TypeMirror type, char inner_class_separator) {
   ...
   * won't work at code generation time. See http://bugs.sun.com/bugdatabase/view_bug.do?bug_id=5089128
   */
  public static Map<String, Object> getAnnotation(Class<?> annotation_type, Element element) {
      ...
      for (Map.Entry<? extends ExecutableElement, ? extends AnnotationValue> entry
        ...
        if (!lenientIsInstance(default_value.getClass(), value)) {
          throw new IllegalStateException(String.format(
              ...
              , annotation_type, name, value.getClass().getName(),
  ...
  /**
   * Returns true if {@code value} can be assigned to {@code expected_class}. Like {@link
   * Class#isInstance} but more lenient for {@code Class<?>} values.
   */
